# dont question this shit code but like it works so who is arguing lmao
# This program was a remake of another project by @isarsindri
str = ''' _       _                  _                                     
( )  _  ( )                ( )   /'\_/`\                          
...
print(str)
print("\nMade by @IcyyBird")
print("https://github.com/IcyyBird")
...
tk.Label(
    footer,
    text="https://github.com/IcyyBird",
    font=("Segoe UI", 11),
    fg=MUTED,
    bg=BG
).pack()
